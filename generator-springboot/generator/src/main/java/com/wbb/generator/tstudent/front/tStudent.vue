          ...
          <a-form-model ref='ruleInsertForm' :rules="rules" :model="insertForm" :label-col="labelCol" :wrapper-col="wrapperCol">
            <!-- <a-form-model-item ref="name" label="name" prop="name">
                ...
                <a-form-model-item ref="gender" label="性别" prop="gender">
                        <a-input v-model="insertForm.gender" @blur="() => {$refs.gender.onFieldBlur();}" />
                    </a-form-model-item>
                <a-form-model-item ref="age" label="age" prop="age">
                        <a-input v-model="insertForm.age" @blur="() => {$refs.age.onFieldBlur();}" />
                    </a-form-model-item>
                <a-form-model-item ref="phoneNumber" label="手机号" prop="phoneNumber">
                        <a-input v-model="insertForm.phoneNumber" @blur="() => {$refs.phoneNumber.onFieldBlur();}" />
                    </a-form-model-item>
                    <a-form-model-item label="classId">
                        <a-select v-model="insertForm.classId" placeholder="">
                            <a-select-option v-for="item in tClassList" :key="item.id" :value="item.id">
                               {{item.className}}
                            </a-select-option>
                        </a-select>
                    </a-form-model-item>
        ...
        <div class="entity-update">
          <a-form-model ref='ruleUpdateForm' :rules="rules" :model="updateForm" :label-col="labelCol" :wrapper-col="wrapperCol">
            <!-- <a-form-model-item ref="name" label="name" prop="name">
                ...
                <a-form-model-item ref="gender" label="性别" prop="gender">
                        <a-input v-model="updateForm.gender" @blur="() => {$refs.gender.onFieldBlur();}" />
                    </a-form-model-item>
                <a-form-model-item ref="age" label="age" prop="age">
                        <a-input v-model="updateForm.age" @blur="() => {$refs.age.onFieldBlur();}" />
                    </a-form-model-item>
                <a-form-model-item ref="phoneNumber" label="手机号" prop="phoneNumber">
                        <a-input v-model="updateForm.phoneNumber" @blur="() => {$refs.phoneNumber.onFieldBlur();}" />
                    </a-form-model-item>
                    <a-form-model-item label="classId">
...
const columns = [
  // { title: 'id', width: 100, dataIndex: 'name', key: 'id', fixed: 'left' },
	...
	{ title: '手机号', width: 100, dataIndex: 'phoneNumber', key: 'phoneNumber'},
