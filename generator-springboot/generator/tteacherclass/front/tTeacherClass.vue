          ...
          <a-form-model ref='ruleInsertForm' :rules="rules" :model="insertForm" :label-col="labelCol" :wrapper-col="wrapperCol">
            <!-- <a-form-model-item ref="name" label="name" prop="name">
                ...
                <a-form-model-item ref="id" label="id" prop="id">
                    ...
                    <a-form-model-item label="teacherId">
                        <a-select v-model="insertForm.teacherId" placeholder="">
                            <a-select-option v-for="item in tTeacherList" :key="item.id" :value="item.id">
                               {{item.teacherName}}
                            </a-select-option>
                        </a-select>
                    </a-form-model-item>                    <a-form-model-item label="classId">
          ...
          <a-form-model ref='ruleUpdateForm' :rules="rules" :model="updateForm" :label-col="labelCol" :wrapper-col="wrapperCol">
            <!-- <a-form-model-item ref="name" label="name" prop="name">
                ...
                <a-form-model-item ref="id" label="id" prop="id">
                    ...
                    <a-form-model-item label="teacherId">
                        <a-select v-model="updateForm.teacherId" placeholder="">
                            <a-select-option v-for="item in tTeacherList" :key="item.id" :value="item.id">
                               {{item.teacherName}}
                            </a-select-option>
                        </a-select>
...
const lowerCaseName = 'tteacherclass'
const columns = [
  ...
  methods: {
    ...
    clickEdit(id) {
      ...
      this.changeViewModel('update')
			...
			this.selectForeignKey('tteacher','tTeacherList')
